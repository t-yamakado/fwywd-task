...
export const SkillSet: React.FC<{}> = ({}) => (
	<div>
		<p className="pl-10 pt-2 sm:pt-5 text-black sm:pl-10 pt-5">
			ここにテキストを書く
		</p>
		<h1 className="pl-10 pt-2 sm:pt-5 text-black sm:pl-10 pt-5">
			JavaScript <span className="text-xs text-yellow-400">60%</span>
		</h1>
		<div className="mt-2 ml-10 sm:ml-10 h-3 relative w-60 rounded-full overflow-hidden">
